...
<body>
	<table width="999" class="thin-border" align="center"
		style="margin-top: 20px">
		<tr>
			<td>订单编号：${o.id }&nbsp; 
				订单状态：
				<c:if test="${o.status eq 1 }">已订单</c:if>
		...
		<tr>
			<td>购买人：${o.user.nickname } &nbsp;发货地址：${o.address.name }(${o.address.postcode })[${o.address.phone }]
			</td>
		</tr>
		<tr>
			<td>购买商品，总价：${o.price}</td>
		</tr>
		<tr>
			<td>
				<table width="999" class="thin.boder">
					...
					<c:forEach items="${o.products }" var="p">
						<tr>
							<td>
								<img src="<%=request.getContextPath() %>/img/${p.product.img}" width="100" height="100" align="center" />
							</td>
