...
public class TestInit {
	...
	private static String randomName( ) {
		return firstName[random.nextInt(firstName.length)] +
				centerName[random.nextInt(centerName.length)] +
